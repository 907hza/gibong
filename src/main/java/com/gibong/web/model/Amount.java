...
public class Amount implements Serializable
{
	...
	private int total;	// Integer	전체 결제 금액
	private int tax_free;	// 	Integer	비과세 금액
	private int vat;	// 	Integer	부가세 금액
	private int point;	// 	Integer	사용한 포인트 금액
	private int discount;	// 	Integer	할인 금액
	private int green_deposit;	// 	Integer	컵 보증금
