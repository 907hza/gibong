...
public class kakaoPayReady implements Serializable // 결제 준비를 위한 클래스 Response Body Payload
{
	private static final long serialVersionUID = 1L;
	
	private String tid;	// String	결제 고유 번호, 20자
	private String next_redirect_app_url;	// String	요청한 클라이언트(Client)가 모바일 앱일 경우
	                        // 카카오톡 결제 페이지 Redirect URL
	private String next_redirect_mobile_url;	// String	요청한 클라이언트가 모바일 웹일 경우
	                                            // 카카오톡 결제 페이지 Redirect URL
	private String next_redirect_pc_url;	    // String	요청한 클라이언트가 PC 웹일 경우
	...
	private Date created_at;	                // Datetime	결제 준비 요청 시간
