...
public class KakaoPayApprove implements Serializable
{
	...
	private String aid;	// String	요청 고유 번호 - 승인/취소가 구분된 결제번호
	private String tid;	// String	결제 고유 번호 - 승인/취소가 동일한 결제번호
	...
	private CardInfo card_info;	// CardInfo	결제 상세 정보, 결제 수단이 카드일 경우만 포함
