		...
		$("#btnUpload").on("click", function(){
			...
			$.ajax({
				...
				success:function(response)
				{
					...
					{
						alert("게시물 업로드 중 알 수 없는 오류가 발생했습니다.");
					}
				},
		...
		<div class="container">
				<div class="col-lg-8" style="margin: 0 auto;">
					<div class="single-article-section" style="margin: 0 auto;">
						...
						<h1 id="font" style="color: #554838; font-size: 50px">봉사후기 글 작성</h1>
							<div>
							</div>
						...
						<div id="image_preview">
							...
							<h3><input type="text" id="reviewTitle" name="reviewTitle" placeholder="제목" style="outline: none; border:0px;"/></h3>
							<hr class="hr-3">
							<img id="preview" onchange="readURL(this);" onkeydown="resize(this)" onkeyup="resize(this)"/>
						
							<textarea class="newTweetContent" id="reviewContent" name="reviewContent" onkeydown="resize(this)" onkeyup="resize(this)" ></textarea>
							</p>
						</div>
					</div>
				</div>
